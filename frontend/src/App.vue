        ...
        <section v-if="activeNav === 'SiteDetail' && selectedSite" class="site-detail-view">
          ...
          <template v-else-if="selectedSiteTab === 'Repository'">
            ...
            <div class="repository-editor panel">
              ...
              <div class="wizard-hint"><CircleHelp :size="15" /><span>La Atomic, ultima versiune pregătită rămâne în <code>{{ selectedSite.project_root }}/.current</code>, iar scriptul implicit publică fișierele direct în document root-ul site-ului. La In-place se actualizează direct rădăcina existentă.</span></div>
